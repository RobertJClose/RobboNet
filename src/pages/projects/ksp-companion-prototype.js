    ...
    <Layout pageTitle="RobboNet: KSP Companion (Prototype)">
      <article>
        ...
        <p>
          ...
          I've been playing KSP since I was a teenager, and always felt that
          with my blossoming maths and physics skills I could go beyond the
        ...
        <p>
          I'm especially proud of three of the struct/classes I built during
          this project.
        </p>
        ...
        <p>
          ...
          structs to make it simpler to write the large amount of code that
          worked with floating point values that semantically represented
          angles. Angular values are similar to floats and doubles, but with
          periodic equivalence at integer multiples of 2&pi;. This can make
          common tasks, such as working out if an angle is between two others,
          more complex. The two angle structs have public methods for computing
          many non-trivial cases such as this, and all the tricky equivalence
          issues are resolved under-the-hood. Best of all, angle objects can be
          implicitly cast (explicitly where appropriate) to floating point
          values, so the syntax for methods expecting floats or doubles doesn't
          change in any way. It's hard to state just how much utility and peace
          of mind I got from these structs as I worked on this project,
          particularly when I created this next class.
        </p>
        ...
        <p>
          ...
          class was the backbone on which the KSP Companion was built, as an
          Orbit object can flexibly represent all three types of{" "}
          ...
          satellite's orbit, while all of tricky mathematics remains hidden in
          the implementation where it belongs. I actually didn't have any
          lectures on orbital mechanics during my four years studying physics,
          so I sourced a textbook and studied{" "}
          <a
          ...
          are still some adjustments I might make to its design before
          committing it into a proper library, I found my Orbit class a real
          pleasure to use.
        </p>
        <h3>Professional and Strategic Programming</h3>
        <p>
          ...
          comments to improve the readability of the code, as well as to
          highlight any tricky bug-squashing details.
        </p>
        <p>
          This project was my first taste of unit testing, and these classes
          became meticulously well tested. I created 313 tests in total, each of
          them built according to the Arrange-Act-Assert design pattern. Some of
          these tests required long handwritten computations in order to check
          their accuracy, with one especially{" "}
          <a
            href="/images/NotebookHandwrittenTestIterations.png"
            target="_blank"
          >
            spicy
          </a>{" "}
        ...
        <p>
          ...
          as 'strategic' programming, as opposed to 'tactical' programming that
          moves fast and breaks things. While I learnt a lot during this
          project, it was an appreciation for strategic programming tasks and
          their long term benefits that has had the greatest impact on my
        ...
        <p>
          ...
          before writing any code, but I still struggled to keep the complexity
          of my code under control as the lines accumulated. If I were to
          complete this project again, I think I'd structure the code
          differently to improve the scalability of my code. I also think I
          could've made better use of Unity's GameObject/Component based
          structure. I think I found it difficult to resolve{" "}
          <a
          ...
          between Unity's flat hierarchy and the inheritance-focused OOP
          learning I had done previously. I understand the purpose and strengths
          of a MonoBehaviour object much better now, and leaning more heavily
          into that will probably help me with my scale issues as well.
        </p>
      </article>
    </Layout>
  );
